...
class Vendor extends BaseEntity{
    ...
    public function getAsTableRow(){
        return '<tr class="align-middle shadow-hover">
                    ...
                    <td>
                        <a class="btn btn-outline-warning btn-sm me-1" href="./Vendors.php?action=update&id='.$this->id.'">Редагувати</a>
                        <a class="btn btn-outline-danger btn-sm" href="./Vendors.php?action=delete&id='.$this->id.'">Видалити</a>
                    </td>
                </tr>';
    }
