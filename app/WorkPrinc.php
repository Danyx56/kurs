...
class WorkPrinc extends BaseEntity{
    ...
    public function getAsTableRow(){
        return '<tr>
                    ...
                    <td>'.$this->name.'</td>
                    <td>
                        <a class="btn btn-warning" href="./WorkPrincs.php?action=update&id='.$this->id.'">Редагувати</a>
                        <a class="btn btn-danger" href="./WorkPrincs.php?action=delete&id='.$this->id.'">Видалити</a>
                    </td>
                </tr>';
    }
