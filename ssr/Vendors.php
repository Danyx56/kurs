...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if($_POST['id']==""){
        ...
        if ($result === false) {
            $errorMessage = "Помилка: Такий виробник вже існує!";
        }
    } else{
        $result = $a->updateDatabaseById(['id'=>$_POST['id'],'name'=>$_POST['name']]);
        if ($result === false) {
            $errorMessage = "Помилка: Виробник з такою назвою вже існує!";
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form method="POST">
                        ...
                        <?php endif; ?>
                        <p>
                            <input type="text" name="name" value="<?php echo $item?$item['name']:'';?>" class="form-control" placeholder="Назва виробника" required/>
                        </p>
                        <p>
